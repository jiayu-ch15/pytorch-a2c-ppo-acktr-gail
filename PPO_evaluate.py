...
if __name__ == '__main__':
    ...
    # start = time.time()
    for i in range(nagents):
        actor_critic, ob_rms = torch.load('/home/chenjy/pytorch-a2c-ppo-acktr-gail/trained_models/ppo' + args.model_dir + '/agent_%i' % (i+1) + ".pt")
    ...
    for ep_i in range(n_episodes):
        ...
        for t_i in range(episode_length):
            ...
            for i in range(nagents):
                ...
                value, action, _, recurrent_hidden_states = agents[i].act(share_obs, obs, recurrent_hidden_states, masks)
